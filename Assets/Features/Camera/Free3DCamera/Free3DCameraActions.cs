...
//     version 1.13.1
//     from Assets/Features/Camera/Free3DCamera/Free3DCameraActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Features/Camera/Free3DCamera/Free3DCameraActions.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @Free3DCameraInputActions: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    /// </summary>
    public @Free3DCameraInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Free3DCameraActions"",
    ""maps"": [
        {
            ""name"": ""Camera"",
    ...
    ~@Free3DCameraInputActions()
    {
        UnityEngine.Debug.Assert(!m_Camera.enabled, "This will cause a leak and performance issues, Free3DCameraInputActions.Camera.Disable() has not been called.");
    }
    ...
    {
        private @Free3DCameraInputActions m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public CameraActions(@Free3DCameraInputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
